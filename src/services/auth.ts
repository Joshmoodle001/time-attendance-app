...
function createExampleUsers(): AuthUser[] {
  ...
  return [
    ...
    {
      username: "divisional@pfm.co.za",
      secret: "Div123!",
      role: "divisional" as AuthRole,
      name: "Divisional",
      surname: "Manager",
      createdAt: now,
      updatedAt: now,
    ...
    {
      username: "regional@pfm.co.za",
      secret: "Reg123!",
      role: "regional" as AuthRole,
      name: "Regional",
      surname: "Leader",
      createdAt: now,
      updatedAt: now,
